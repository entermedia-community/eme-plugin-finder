...
docker run -t -d \
	...
	-v ${ENDPOINT}/webapp:/usr/share/eme-instance/webapp \
	-v ${ENDPOINT}/data:/usr/share/eme-instance/data \
	-v ${ENDPOINT}/elastic:/usr/share/eme-instance/elastic \
	-v ${ENDPOINT}/$NODENUMBER/tmp:/usr/share/eme-instance/tmp \
